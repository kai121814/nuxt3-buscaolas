      ...
      <div class="mb-24">
        <div class="
          ...
          <div class="text-2xl text-center lg:py-10 pt-7 pb-3 lg:font-bold font-semibold gray-to-white">
            Historial no esta disponible
          </div>
          <div class="italic font-bold color-gray mt-5">
            <p>Lo sentimos pero al parecer no tenemos historial</p>
          </div>
          <div class="lg:my-7 color-gray">
            <p>Las cámaras esta caída y no existe historial o todavía no activamos el historial para esta cámara 
            </p><p>Si necesitas ayuda escríbenos a <span class="font-bold">  contacto@buscaolas.cl</span></p>
          </div>
          <div class="class">
            <button class="lg:visible invisible free-premium border-sm text-center font-bold text-white uppercase lg:mb-10">Intenta de nuevo</button>
          </div>
        </div>
